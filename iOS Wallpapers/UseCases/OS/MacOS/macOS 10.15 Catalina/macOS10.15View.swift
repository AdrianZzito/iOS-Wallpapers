...
struct macOS10_15View: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            List {
                ForEach(macOS10_15Wallpapers) { wallpaper in
                    VStack {
            ...
            .navigationTitle("macOS 10.15 Catalina")
...
struct macOS10_15View_Previews: PreviewProvider {
