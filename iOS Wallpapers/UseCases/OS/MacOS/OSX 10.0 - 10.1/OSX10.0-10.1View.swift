...
struct OSX10_0_10_1View: View {
    ...
    var body: some View {
        ...
        VStack {
            List {
                ForEach(OSX10Wallpapers) { wallpaper in
                    VStack {
            ...
            .navigationTitle("OS X 10.0 Cheetah & 10.1 Puma")
            .navigationBarTitleDisplayMode(.inline)
        }
    }
}

struct OSX10_0_10_1View_Previews: PreviewProvider {
