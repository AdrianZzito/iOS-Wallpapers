...
struct macOS10_14View: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            List {
                ForEach(macOS10_14Wallpapers) { wallpaper in
                    VStack {
            ...
            .navigationTitle("macOS 10.14 Mojave")
            .navigationBarTitleDisplayMode(.inline)
        }
    }
}

struct macOS10_14View_Previews: PreviewProvider {
